...
export const QUESTION_TYPES= [{ type:'', label:'', maxOptionDefinitions:0 },
                                                                    { type:'scale_five', label:'Scale (1 to 5)', maxOptionDefinitions:5 },
...
export const QUESTION_SKELETON = { id:null, title:'',
                                                                            isAllowUpload:false,
