...
describe('Categories actions: ', () => {
    ...
    it('selectCategory function should dispatch 4 actions when there are subcategories', () => {
        const test = {
            id: 1,
            type: 'categories',
            attributes: {
    ...
    it('selectCategory function should dispatch 4 action when there are no subcategories', () => {
        const test = {
            id: 1,
            type: 'categories',
            attributes: {
